...
## ✨ Fitur Utama
* **Dashboard Statistik:** Ringkasan total barang, kategori, dan supplier secara real-time.
* **Manajemen Barang:** Tambah, edit, hapus, dan cari barang dengan indikator stok rendah.
* **Manajemen Kategori:** Pengelompokan barang untuk organisasi yang lebih baik.
* **Manajemen Supplier:** Pendataan mitra bisnis/partner supplier.
* **Sistem Keamanan:** Proteksi halaman dengan Session Storage (Login diperlukan untuk akses dashboard).
* **Data Persistence:** Menggunakan `localStorage` browser sehingga data tidak hilang saat halaman di-refresh.
* **Responsive Design:** Optimal diakses melalui Desktop, Tablet, maupun Smartphone.
